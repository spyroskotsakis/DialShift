...
> **Current status (2026-09-25, native-check pass on the dev box, branch `refactor/single-codebase-timezone` at `2c0909e`).** Phase 1 and Phase 2 are merged, and WPF is retired. The merged waves are:
