...
> at `9322106` (run `36235173662`), with D101's fifth round pending its run; NC-19
...
- **Refusals first:** R2 (the install lock, exit 11), `CheckFolderPath` as in R3 (b) (exit 13, D101): a drive or share
  ...
  folder. …`; exit 13); and R5 (DialShift running, Retry/Cancel, exit 10; 15 when it can't be checked), as in §5.4.
