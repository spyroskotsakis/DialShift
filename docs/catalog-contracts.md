...
> and the last two (CAT-12's Escape-then-Enter case, CAT-01's rule 9 mirror) in `f45aeeb` (merged at `8836ec3`). The CAT rows' final statuses (Phase 6) are in `docs/acceptance-matrix.md` §11.
