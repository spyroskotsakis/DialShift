...
> `docs/decisions.md` (D59–D68 are the brief's §11 defaults, D69–D76 the ambiguities resolved in Phase 0, D77–D85
...
> **not implemented yet** (UI lane fix round 1, then the test lane).
