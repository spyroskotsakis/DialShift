...
- **Consequence:** Evidence: `58b813a`, the review fixes in `dc032fe`, and the install lock, exact-name cleanup and CI helper fix in `65771f7`. Matrix §7.10 SW-N4 is GREEN-pending-CI until the step's first green run.
