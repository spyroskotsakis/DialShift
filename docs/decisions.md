...
- **Status:** Adopted (spec lane, 2026-09-25, after verifying the integration lane's Phase 3 diff `d05180b` and `3a10dae`, merged at `d489465`). Amends `docs/catalog-contracts.md` §4.2, §4.3 and §4.4, which now match the code. It changes nothing in D60, D66, D69 or D74 except where it says so.
