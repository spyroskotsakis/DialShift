...
- **Update (D57):** `v0.3.0` ships as a full release in the development tier (Windows unsigned, macOS ad-hoc), before Authenticode and notarization. The public-release requirement above still stands for later full releases unless another decision says otherwise.
