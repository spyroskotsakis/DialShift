...
| Brief 4 (Windows setup) | **Implemented, not merged or released** (2026-09-26): `docs/windows-installer.md`, D93–D99, D101; public CI `36230181228` at `b655d67` and `36231552864` at `cf21fc1` green on both OSes, the Mac-built and Windows-built setups byte-identical | [Matrix §12](acceptance-matrix.md#12-windows-installer-brief-4): 11 GREEN, 5 NATIVE-PENDING, 4 TODO |
