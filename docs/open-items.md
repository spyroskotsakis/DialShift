...
> - [docs/decisions.md](decisions.md): decisions D1–D92 and D100 (brief 3 from D59 to D92).
>
...
| Decisions | D1–D92, D100 and D102 recorded (brief 3: D59–D92; D100: the 0.4.1 fix for `https://` stations on Windows; D102: CAT-16 measured at the JIT's steady state, retried only on a busy machine) | [docs/decisions.md](decisions.md) |
