...
> - [docs/decisions.md](decisions.md): decisions D1–D102 and D104 (brief 3 from D59 to D92; brief 4, the Windows setup, D93–D99, D101 and D104; D103 is on `main`'s `fix/log-rotation`; D100, the 0.4.1 fix for `https://` stations on Windows; D102, CAT-16 at the JIT's steady state).
>
...
| Decisions | D1–D102 and D104 recorded (brief 3: D59–D92; brief 4, the Windows setup: D93–D99, D101 and D104 (the setup's own Welcome/Finish image); D100: the 0.4.1 fix for `https://` stations on Windows; D102: CAT-16 measured at the JIT's steady state, retried only on a busy machine) | [docs/decisions.md](decisions.md) |
